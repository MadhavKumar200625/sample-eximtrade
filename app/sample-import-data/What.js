      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div>
          <p className="uppercase tracking-wide font-semibold mb-2 text-black">
            Armenia Top 10 Major Imports
          </p>
          <h2 className="text-3xl font-bold mb-4 text-black">
            What Does Armenia Import?
          </h2>
          <p className="text-lg mb-4 text-black">
            In FY 2024, Mineral Fuels accounted for the maximum number of
            shipments having a share of over 18% in Armenia total imports. As
            per Armenia import shipment data, Armenia top 10 major imports were
            Mineral fuels ($2.26B) , Electrical machinery ($862M) , Nuclear
            reactors ($848M) , Vehicles ($817M) , Natural or cultured ($692M) ,
            Plastics and articles ($236M) , Pharmaceutical products ($216M) ,
            Iron and steel ($207M) , Optical medical instruments ($186M) ,
            Articles of iron ($175M)
          </p>
          <p className="text-lg mb-6 text-black">
            The top 10 product imports of Armenia were valued to be $6.499
            Billion having over 75.31%. You can have a more brief understanding
            of Armenia major commodity exports in the visual chart given below.
          </p>
          ...
          <div className="mt-4">
            <div className="flex justify-center ">
              ...
              >
               Get Armenia Imports Products Data 2023
              </Link>
            </div>
          </div>
        </div>
