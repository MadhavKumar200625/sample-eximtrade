    ...
    <section className="bg-[#f4f9ff] py-20 px-6 md:px-16">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <p className="text-md md:text-xl text-gradient bg-gradient-to-r from-blue-600 via-purple-600 to-pink-500 bg-clip-text text-transparent mb-4">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <Link href="global-trade-database"><button className="relative px-6 py-3 bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 text-white rounded-full font-semibold shadow-xl hover:scale-105 hover:shadow-2xl transition-all duration-300">
              <span className="z-10 relative">Explore Exim GTIS</span>
            </button></Link>

            {/* Get API Access Button - Hover Sweep Gradient */}
            <Link href="api-development-and-integration-company"><button className="relative overflow-hidden px-6 py-3 bg-gray-100 hover:text-white hover:scale-105 text-blue-700 border border-blue-500 rounded-full font-semibold shadow-md group">
