...
const Hero = () => {
  return (
    <section className="relative bg-gradient-to-br from-blue-50 via-white to-blue-100 py-32">
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-10 items-center relative z-10">
        ...
        <div className="space-y-6">
          <div className="bg-white/60 backdrop-blur-sm border-l-4 border-blue-500 p-5 rounded-xl shadow-md hover:shadow-xl transition duration-300">
          ...
          <div className="border-l-8 border-blue-500 bg-white/60 backdrop-blur-sm p-5 rounded-xl shadow-lg hover:shadow-2xl transition duration-300">
            <p className="text-gray-800 text-lg leading-relaxed">
