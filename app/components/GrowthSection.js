      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <p className="text-lg text-gray-700 mb-6">
            ...
            workflow. Find the latest market trends, most traded HS codes,
          ...
          <p className="text-base text-gray-600 mb-6">
            ...
            suppliers from over 200+ countries. Double your sales and generate
            the maximum revenue through our market research platform.
          </p>
          <div className="flex flex-wrap gap-4">
            {/* Explore Button - Vibrant Gradient */}
            <button className="relative px-6 py-3 bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 text-white rounded-full font-semibold shadow-xl hover:scale-105 hover:shadow-2xl transition-all duration-300">
              <span className="z-10 relative">Explore Exim GTIS</span>
            </button>

            {/* Get API Access Button - Hover Sweep Gradient */}
            <button className="relative overflow-hidden px-6 py-3 bg-gray-100 hover:text-white hover:scale-105 text-blue-700 border border-blue-500 rounded-full font-semibold shadow-md group">
