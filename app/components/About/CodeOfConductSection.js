...
const CodeOfConductSection = () => {
  return (
    <section className="py-14 bg-gradient-to-br from-white via-gray-50 to-blue-100">
  <div className="mx-8 px-6 md:px-10 lg:px-16 flex flex-col lg:flex-row items-center gap-12">
    ...
    <div className="w-full lg:w-2/3 px-4">
      ...
      <blockquote className="italic text-indigo-600 font-semibold text-lg border-l-4 border-indigo-500 pl-4">
