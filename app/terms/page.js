  ...
  return (
    <div className="bg-white pt-32 pb-24 px-6 md:px-12 lg:px-20 max-w-7xl mx-auto">
      <header className="mb-16 text-center">
        <h1 className="text-4xl font-extrabold text-neutral-800 mb-4">Terms Of Service</h1>
      </header>
        <h2 className="text-2xl font-semibold text-gray-900 mb-4 border-l-4 pl-4 border-blue-600">Exim Trade Data : Terms Of Service</h2>
      ...
      <section className="space-y-16 mt-16">
        {/* Section */}
        <div>
          <h3 className="text-2xl font-semibold text-gray-900 mb-4 border-l-4 pl-4 border-blue-600">Collection of Personal Information</h3>
        ...
        {/* Section */}
        <div>
          <h3 className="text-2xl font-semibold text-gray-900 mb-4 border-l-4 pl-4 border-blue-600">Changes and Modifications to the Website</h3>
          <p className="text-gray-700 text-base leading-relaxed">
        ...
        {/* Section */}
        <div>
          <h3 className="text-2xl font-semibold text-gray-900 mb-4 border-l-4 pl-4 border-blue-600">Use of Personal Information</h3>
          ...
          <div className="grid md:grid-cols-1 gap-5">
            {[
              ...
              <div key={index} className="bg-blue-50 text-black p-4 rounded-xl shadow-sm border border-blue-100">
                {item}
              </div>
            ))}
          </div>
        ...
        {/* Section */}
        <div>
          <h3 className="text-2xl font-semibold text-gray-900 mb-4 border-l-4 pl-4 border-blue-600">Disclosure of Personal Information</h3>
          <p className="text-gray-700 text-base leading-relaxed">
        ...
        {/* Section */}
        <div>
          <h3 className="text-2xl font-semibold text-gray-900 mb-4 border-l-4 pl-4 border-blue-600">Information Transfer</h3>
          <p className="text-gray-700 text-base leading-relaxed">
