  ...
  return (
    <section className="relative w-full py-12 overflow-hidden bg-gradient-to-br from-white via-slate-50 to-slate-100 text-gray-900">
      ...
      <div className="container mx-auto px-6 flex flex-col items-center text-center">
        ...
        >
          Get quality leads with Exim GTIS
        ...
        >
Our Armenia import export database could help you trace authentic business leads that will help you increase your sales & revenue. Our online platform is based on updated Armenia customs data.
